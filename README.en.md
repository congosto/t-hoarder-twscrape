...
- **Marcelino Madrigal** ([@soymmadrigal](https://github.com/soymmadrigal)) and **Javier Barriuso** ([@barripdmx](https://github.com/barripdmx)) for the dashboard designs I based mine on and for all their help.
